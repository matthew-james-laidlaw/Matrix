...
TEST(TensorTests, ElementwiseSubtractionThrowsOnMismatchedDimensions)
{
    EXPECT_THROW(m1 - m2, std::runtime_error);
}
...
TEST(TensorTests, ElementwiseMultiplicationThrowsOnMismatchedDimensions)
{
    EXPECT_THROW(m1 * m2, std::runtime_error);
}
...
TEST(TensorTests, ElementwiseDivisionThrowsOnMismatchedDimensions)
{
    EXPECT_THROW(m1 / m2, std::runtime_error);
}
